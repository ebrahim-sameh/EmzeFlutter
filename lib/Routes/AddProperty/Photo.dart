        ...
        child: Padding(
           padding: EdgeInsets.symmetric(vertical:25,horizontal: 25 ),
            ...
            Navigator.pop(context);
               ...
               SizedBox(height: 20,),
                Text("Photos help travelers imagine themselves into your accommodation. You can start with one photo and add more after posting",style: TextStyle(fontSize: 18,color:Colors.black87,fontWeight: FontWeight.w400),),
               SizedBox(height: 30,),
                MaterialButton(
                  onPressed: (){
                    /*Navigator.push(
                ...
                Align(
                  ...
                  child: MaterialButton(
                    ...
                    child: Container(
                        ...
                        child: Text("Add later",style: TextStyle(color: Colors.red),)),
                  ),
                ),
    ],
    ),
