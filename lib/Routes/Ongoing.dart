      ...
      child: Column(
          ...
          children: [
           Image.asset(imagePath,width: MediaQuery.of(context).size.width,),
                ...
                for(int i=0;i<SliderModel.getSlides().length;i++)
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: current ==  i ? Constants.redAirbnb:Colors.grey[400]
                    ),
                  ),
              ],
            ),
            ...
            SizedBox(height: 15,),
            Text(title,style: TextStyle(fontSize: 22,color: Colors.white,fontWeight: FontWeight.w600),textAlign: TextAlign.center,),
            SizedBox(height: 15,),
            Text(text,style: TextStyle(fontSize: 18,color: Colors.white),textAlign: TextAlign.center,),
