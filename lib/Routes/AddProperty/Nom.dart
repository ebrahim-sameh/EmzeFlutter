          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 30,),
                Text("Name your ad",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w500),),
                SizedBox(height: 20,),
                Text("Attract travelers with a listing title that highlights what makes your place special",style: TextStyle(fontSize: 18,color:Colors.black87,fontWeight: FontWeight.w400),),
                SizedBox(height: 30,),
                TextField(
