                       ...
                       child: Padding(
                         padding:  EdgeInsets.symmetric(horizontal: 15,vertical: 10),
                            child: Row(
                             ...
                             children: <Widget>[
                               Icon(Icons.search),
                               Text("search locations, tourist sites",style:TextStyle(fontSize: 13,color: Colors.black54),
                        ...
                        Positioned(
                          ...
                          child: MaterialButton(
                            ...
                            child: Container(
                                ...
                                child: Text("Check now!",style: TextStyle(color: Colors.red),)),
                          ),
                        )
                      ],
                    ),
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: Text("Emze",style: TextStyle(color:Color(0xfff35e0b)),)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(bottom: 10,right: 10,left: 10),
                          child: Text("Meet people all over Algeria and discover the most beautiful places in the country. With Emze.",style: TextStyle(fontSize: 13,color:Color(0xffd3d3d3)),),
                        ),
                        Expanded(
                          child: Container(
                            color: Colors.white,
                            child: PageView(
                              ...
                              children: <Widget>[
                                buildScrollActivities("the best holidays", "assets/images/3.jpg"),
                                buildScrollActivities("Family housing", "assets/images/4.jpg"),
                                buildScrollActivities("Quiet places", "assets/images/1.jpg"),
                                buildScrollActivities("Quiet places", "assets/images/2.jpg"),
                              ],
                            ),
                          ),
                        )
