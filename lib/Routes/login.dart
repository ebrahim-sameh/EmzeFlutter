                  ...
                  child: Container(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.person_outline,color: Constants.redAirbnb,)
                      ),
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      border: InputBorder.none,
                      hintStyle: TextStyle(color: Colors.grey),
                      prefixIcon: Icon(Icons.mail_outline,color:Color(0xfff3983f),),
                    ),
                  ),
                ),
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        border: InputBorder.none,
                        hintStyle: TextStyle(color: Colors.grey),
                        prefixIcon: Icon(Icons.lock_outline,color:Color(0xfff3983f),)
                    ),
                  ),
                ),
                Visibility(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                        ...
                        child: Text("Forgot password ?",style: TextStyle(color:Color(0xfff3983f),fontSize: 12),)),
                  ),
                ),
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  ...
                                  style: TextStyle(color:Color(0xfff3983f),fontWeight: FontWeight.w600, fontSize: 14),)
                              ]),
                        ),
                      ),
                    ),
