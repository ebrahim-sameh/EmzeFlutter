                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Start by choosing a general category",style: TextStyle(color:Colors.grey,fontSize: 13,fontWeight: FontWeight.w300),),
                    ),
                  ],
                ),
              ),
              ...
              InkWell(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      padding:  EdgeInsets.fromLTRB(10,8,10,0),
                      child: Text("now choose a type of accommodation",style: TextStyle(color:Colors.black,fontSize: 15,fontWeight: FontWeight.w400),),
                    ),
                    Padding(
                      padding:  EdgeInsets.fromLTRB(10,12,10,3),
