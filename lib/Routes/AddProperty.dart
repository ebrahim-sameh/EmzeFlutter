            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("2 Places",style: TextStyle(color:Colors.black87,fontSize: 22,fontWeight: FontWeight.bold),),
                  Text("Available",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Material(
                    elevation: 3,
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                          height:80,
                            ...
                            child: Center(child: Text("Private room in Algeria",style: TextStyle(fontSize:15,fontWeight: FontWeight.w300),maxLines: 5,textAlign: TextAlign.center,))),
                        Container(
