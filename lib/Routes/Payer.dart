           ...
           children: <Widget>[
            Row(
             ...
             Row(
               mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: <Widget>[
                 Text("2500 x 5 nights",style: TextStyle(color: Colors.grey,fontSize: 16),),
                 ...
                 children: [
                   ...
                   MaterialButton(
                     child: Container(
                         ...
                         child: Text("Meet and pay to confirm",style: TextStyle(color: Colors.white),textAlign: TextAlign.center,)),
                   ),
